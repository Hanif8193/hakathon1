...
const Bodon = Bodoni_Moda({subsets:["latin"], weight:"800"});
    ...
    <div>
      <div className="bg-black text-white w-full h-[100px] px-8 py-5  mt-5">
        <ul className="flex justify-center space-x-3 md:justify-between items-center text-center flex-wrap">
          <li className= {`${Playfair.className}text-2xl md:text-4xl`}> VERSAC</li>
          <li  className= {`${cinzel.className}text-2xl md:text-4xl`}> ZARA</li>
          <li  className= {`${Bodon.className}text-2xl md:text-4xl`}>GUCCI</li>
          <li  className= {`${parata.className}text-2xl md:text-4xl`}>PARADA</li>
          <li  className= {`${montsserrat.className}text-2xl md:text-4xl`}>Calvin Klein</li>
        </ul>
      </div>
